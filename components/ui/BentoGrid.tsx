...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("songfangyi1210@gmail.com");
        setCopied(true);
    };
    ...
    return (
        <div
            ...
            style={{
                ...
                backgroundColor:
                    "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(0,0,143,1) 46%, rgba(103,103,255,1) 100%)",
            }}
        >
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                >
                    ...
                    <div className="font-sans font-bold text-2xl max-w-96 z-10">
                        {title}
                    </div>
